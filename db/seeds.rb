...
tom_education = Education.new({school: Faker::Educator.university, location: Faker::Address.city, country: Faker::Address.country, remote: false, degree: Faker::Educator.degree, major: Faker::Educator.subject, start_date: Date.new(2007, 9, 1), end_date: Date.new(2011, 7, 1)})
tom_education.resume = tom_resume
tom_education.save!

tom_experience = Experience.new({start_date: Date.new(2012,3,1), end_date: Date.new(2016,4,9), company: Faker::Company.name, description: ["make prototypes", "process controll"], job_title: Faker::Job.title})
